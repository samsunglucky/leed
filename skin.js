...
// Pano2VR 5.2.3/15990
// Filename: simplex_NamVietV1.1.ggsk
// Generated Fri Dec 21 21:59:59 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._tt_zoomin__text.innerHTML="Ph\xf3ng l\u1edbn";
		...
		this._tt_zoomin_white__text.innerHTML="Ph\xf3ng l\u1edbn";
		...
		this._tt_zoomout__text.innerHTML="Thu nh\u1ecf";
		...
		this._tt_zoomout_white__text.innerHTML="Thu nh\u1ecf";
		...
		this._tt_autorotate__text.innerHTML="Xoay";
		...
		this._tt_autorotate_white__text.innerHTML="Xoay";
		...
		this._tt_info__text.innerHTML="Th\xf4ng tin";
		...
		this._tt_info_white__text.innerHTML="Th\xf4ng tin";
		...
		this._tt_movemode__text.innerHTML="\u0110\u1ed5i ch\u1ebf \u0111\u1ed9";
		...
		this._tt_movemode_white__text.innerHTML="\u0110\u1ed5i ch\u1ebf \u0111\u1ed9";
		...
		this._tt_fullscreen__text.innerHTML="To\xe0n m\xe0n h\xecnh";
		...
		this._tt_fullscreen_white__text.innerHTML="To\xe0n m\xe0n h\xecnh";
		...
		this._loadingtext.ggUpdateText=function() {
			var hs="\u0110ang t\u1ea3i... "+(me.player.getPercentLoaded()*100.0).toFixed(0)+"%";
			if (hs!=this.ggText) {
				this.ggText=hs;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hotspot') {
			...
			this._hsimage3__img.className='ggskin ggskin_svg';
			this._hsimage3__img.setAttribute('src',basePath + 'images/hsimage3.svg');
			this._hsimage3__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			...
			this._hsimage3.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._hsimage3.ggVisible=true;
			this._hsimage3.className='ggskin ggskin_svg ';
			this._hsimage3.ggType='svg';
			hs ='';
			hs+='cursor : pointer;';
			hs+='height : 36px;';
			hs+='left : -16px;';
			...
			this._hsimage3.style[domTransform + 'Origin']='50% 50%';
			me._hsimage3.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hsimage3.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage3.ggUpdatePosition=function (useTransition) {
			}
		...
		if (hotspot.skinid=='hotspot_back') {
			this.__div=document.createElement('div');
			this.__div.ggId="hotspot_back";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._hsimage2__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			...
			this._hsimage2.style[domTransform + 'Origin']='50% 50%';
			me._hsimage2.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hsimage2.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage2.ggUpdatePosition=function (useTransition) {
			}
		...
		if (hotspot.skinid=='hotspot_right') {
			this.__div=document.createElement('div');
			this.__div.ggId="hotspot_right";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._hsimage1__img.className='ggskin ggskin_svg';
			this._hsimage1__img.setAttribute('src',basePath + 'images/hsimage1.svg');
			this._hsimage1__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			...
			this._hsimage1.className='ggskin ggskin_svg ';
			this._hsimage1.ggType='svg';
			hs ='';
			hs+='cursor : pointer;';
			hs+='height : 36px;';
			hs+='left : -16px;';
			...
			this._hsimage1.style[domTransform + 'Origin']='50% 50%';
			me._hsimage1.ggIsActive=function() {
				if ((this.parentNode) && (this.parentNode.ggIsActive)) {
					return this.parentNode.ggIsActive();
				}
				return false;
			}
			me._hsimage1.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage1.ggUpdatePosition=function (useTransition) {
			}
		...
		if (hotspot.skinid=='hotspot_left') {
			this.__div=document.createElement('div');
			this.__div.ggId="hotspot_left";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot ';
			this.__div.ggType='hotspot';
			...
			this._hsimage0__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			...
			this._hsimage0.style[domTransform + 'Origin']='50% 50%';
			...
			me._hsimage0.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._hsimage0.ggUpdatePosition=function (useTransition) {
			}
